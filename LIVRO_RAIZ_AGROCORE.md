...
- **Entregas da OE-007.005 — Conclusão e Relatório:**
  ...
  - **Supabase aplicado:** a migration `oe_007_005_visit_completion_reports` está registrada no projeto Supabase AgroCore; tabela, RLS e RPCs foram verificados remotamente. Os RPCs usam `SECURITY DEFINER` com `search_path` vazio e checagens internas explícitas de autorização.
