...
export const PERMISSIONS_CATALOG: readonly PermissionDefinition[] = [
  ...
  // Documentos
  {
    ...
    description: 'Visualizar informações e referências documentais conforme o escopo autorizado.',
  },
  {
    id: 'documents:upload',
    scope: 'documents',
    ...
    description: 'Enviar arquivos permitidos para registros relacionados ao próprio escopo operacional.',
  },
  {
    ...
    description: 'Abrir e baixar arquivos privados conforme o escopo autorizado.',
  },
  {
    ...
    description: 'Registrar as informações de identificação e classificação dos documentos.',
  },
  {
    id: 'documents:manage',
    scope: 'documents',
