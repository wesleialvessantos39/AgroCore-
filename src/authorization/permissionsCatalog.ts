...
export const PERMISSIONS_CATALOG: readonly PermissionDefinition[] = [
  ...
  // Propostas de Crédito
  {
    ...
    description: 'Acompanhar o andamento, pareceres e status de propostas de crédito.',
  },
  {
    id: 'proposals:create',
    scope: 'proposals',
    targetScope: 'organization',
    name: 'Elaborar Propostas',
    description: 'Iniciar novas propostas de crédito rural com dados agronômicos preliminares.',
  },
  {
    id: 'proposals:edit',
    scope: 'proposals',
    targetScope: 'organization',
    name: 'Editar Propostas',
    description: 'Ajustar planilhas técnicas, cronogramas e dimensionamentos de projetos.',
  },
