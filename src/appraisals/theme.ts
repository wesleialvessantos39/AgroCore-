/**
 * TOKENS VISUAIS OFICIAIS AGROCORE — MÓDULO 004 (LAUDOS DE AVALIAÇÃO)
 * Paleta estrita:
 ...
 *
 * Em conformidade com a OE-004.001-R4:
...
export const APPRAISAL_THEME = {
  ...
  btnDangerSecondarySmall:
    'inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[#0B3D2E] bg-white border border-[#0B3D2E]/40 hover:bg-[#0B3D2E]/10 focus:outline-none focus:ring-2 focus:ring-[#78C89A] rounded-lg transition-colors min-h-[36px] cursor-pointer',
