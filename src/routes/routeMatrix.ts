...
export const CENTRAL_ROUTE_MATRIX: readonly RouteDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    scope: 'organization',
    description: 'Consulta dos documentos registrados e permitidos para o usuário.',
  },
  {
  ...
  {
    path: ROUTES.DOCUMENT_REQUIREMENTS,
    category: 'authenticated_protected',
    name: 'Pendências e Prazos de Documentos',
    requiresAuth: true,
    requiredPermissions: 'documents:view_requirements',
    scope: 'organization',
    description: 'Acompanhamento de pendências, vencimentos e documentos que exigem atenção.',
  },
  {
    path: ROUTES.DOCUMENT_REQUIREMENTS_NEW,
    category: 'authenticated_protected',
    name: 'Nova Pendência de Documento',
    requiresAuth: true,
    requiredPermissions: 'documents:manage_requirements',
    scope: 'organization',
