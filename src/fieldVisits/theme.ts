export const FIELD_VISIT_THEME = Object.freeze({
  page: 'space-y-6 text-[#0B3D2E]',
  surface: 'rounded-2xl border border-[#0B3D2E]/15 bg-white shadow-xs',
  surfaceSoft: 'rounded-2xl border border-[#78C89A]/30 bg-[#78C89A]/10',
